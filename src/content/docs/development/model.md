...
description: An overview of the AnimeEntry model used within Kelbrum, used to define an anime and its relevant properties used for display in the UI and recommendations.
---

[AnimeEntry](https://github.com/vikiru/kelbrum/blob/main/src/recommender/models/AnimeEntry.js): This is the main model which is meant to represent a distinct anime entry, including properties such as its `title`, `type`, `genres`, `studios`, `score`, `pageURL`, etc.
