...
function Home() {
    ...
    return (
        <section id="home">
            <section
                className="hero flex items-center justify-center bg-primary py-6 dark:bg-gray-900"
                id="hero"
            >
                <div className="hero-content text-center">
                    <div className="mx-auto">
                        ...
                        <p className="xs:text-md pb-6 pt-4 text-lg text-secondary lg:text-xl xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl dark:text-gray-100">
                            Tired of searching for a new anime or trying to find
                            a new movie to watch but can't find one that suits
                            your taste? Look no further! Search for one of your
                            favorites, and you'll be presented with a selection
                            of similar anime, tailored just for you. Not happy
                            with the suggestions? Refresh and you'll be
                        ...
                        <div className="mx-auto flex items-center justify-center rounded-full border-b-4 border-secondary bg-accent py-2 pt-2 hover:cursor-pointer xs:w-full lg:w-[50%] dark:border-primary">
                            <Link className="flex-grow" to="/anime/search">
            ...
            <div className="bg-secondary px-4 dark:bg-gray-900">
                <h2 className="text-center font-bold text-primary underline xs:text-lg lg:text-4xl ">
                    Random Anime
                </h2>
