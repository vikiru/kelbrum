            ...
            <section id="hero" className="hero flex items-center justify-center bg-primary py-6 dark:bg-gray-900">
                <div className="hero-content text-center">
                    <div className="mx-auto">
                        <h1 className="text-2xl font-bold xs:text-xl lg:text-5xl 2xl:text-6xl 3xl:text-7xl 4xl:text-8xl dark:text-gray-100 text-secondary">
                            Discover Your Next Favourite Anime
                        </h1>
                        <p className="xs:text-md pb-6 pt-4 text-lg lg:text-xl xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl dark:text-gray-100 text-secondary">
